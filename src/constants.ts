...
//TODO: fill in mainnet and testnet input settler programs and remove the undfined types
export const SOLANA_MAINNET_INPUT_SETTLER_ESCROW = undefined;
export const SOLANA_TESTNET_INPUT_SETTLER_ESCROW = undefined;
...
//TODO: fill in mainnet and testnet output settler PDAs and remove the undefined types
export const SOLANA_MAINNET_OUTPUT_SETTLER_PDA = undefined;
export const SOLANA_TESTNET_OUTPUT_SETTLER_PDA = undefined;
export const SOLANA_DEVNET_OUTPUT_SETTLER_PDA =
  "0xabb04f05c412a4892f8c93efa4eda9f360ba8b5c8342bed51207c7a4fdd036d6" as const;

export const solanaOutputSettlersPDAs: Record<string, `0x${string}` | undefined> = {
